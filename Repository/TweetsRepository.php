...
class TweetsRepository extends Db {
  ...
  {
    $sql = "SELECT retweet.ID_tweet as IDTweet, tweet.text as textTweet, tweet.ID_user as UserIDTweet, user.pseudo as pseudo, DATE_FORMAT(tweet.date, '%W %e %M %Y') as dateTweet, IF(aime.ID_user IS NULL, 0, 1) as isLiked from tweet 
