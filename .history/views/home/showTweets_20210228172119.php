...
foreach($retweets as $retweet){ ?>
  ...
  <span>Tweet of <a href="<?="index.php?action=profil&id_user=". $retweet['UserIDTweet'] .""?>"><?=$retweet["pseudo"]?></a> retweeted by <a href="index.php?action=profil&id_user=". $_SESSION['id'] . "<?= $_SESSION["pseudo"] ?> </span>
