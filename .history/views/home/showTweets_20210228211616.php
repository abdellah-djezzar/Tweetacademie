...
foreach($retweets as $retweet){ ?>
  ...
  <button type="submit" class="likeValue far fa-heart" name="id_tweet" value="<?= $retweet["IDTweet"]?>"><?= $countTweet[0] ?></button>
  <?php } else{ ?>
  <button type="submit" class="likeValue fas fa-heart" name="id_tweet" value="<?= $retweet["IDTweet"]?>"><?= $countTweet[0] ?></button>
  <?php } ?>
  </form>
