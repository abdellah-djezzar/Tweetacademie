    ...
    <div class="col-12">
      <ul class="nav nav-tabs navbar-fixed-top" id="myTab" role="tablist">
        ...
        if(isset($_GET['id_user'])){?>
          ...
          <li class="nav-item" role="editprofil">
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="editprofil" role="tabpanel" aria-labelledby="editprofil-tab"><?php include('views/profil/editprofil.p.php')?></div>
        </div>
    </div>
  </div>
</div>