<form action="" method="POST" class="w-100 d-flex flex-column justify-content-center mt-5">
  ...
  <div class="col-12">
  <p>Vos données seront supprimés intégralement de nos serveurs. Attention il ne sera pas possible de les récupérer ultérieusement. Vous perdrez votre historique, abonnements et abonnés.</p>
