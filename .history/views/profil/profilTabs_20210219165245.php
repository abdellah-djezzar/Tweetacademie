    ...
    <div class="col-12">
      <ul class="nav nav-tabs navbar-fixed-top" id="myTab" role="tablist">
        ...
        if(isset($_GET['id_user'])){?>
          ...
          <li class="nav-item" role="presentation">
            <a class="nav-link" id="editprofil-tab" data-toggle="tab" href="index.php?action=messagerie&id_user=<?=$_GET["id_user"]?>" role="tab" aria-controls="editprofil" aria-selected="false">Envoyer un message</a>
          </li>
