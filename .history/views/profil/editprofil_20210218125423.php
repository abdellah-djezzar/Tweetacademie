<form action="" method="POST" class="w-100 d-flex flex-column justify-content-center mt-5">
  <div class="row">
    ...
    <div class="form-group">
         ...
         <input class="w-100" type="text" id="newpassword" name="newpassword" placeholder="Mot de passe">
         </div>

         <div class="form-group">
         <label for="confirmNewPassword">Confirmer le nouveau mot de passe:</label>
         <input class="w-100" type="text" id="confirmNewpassword" name="confirmNewpassword" placeholder="Mot de passe">
         </div>
    </div>
  </div>
         <div class="form-group">
