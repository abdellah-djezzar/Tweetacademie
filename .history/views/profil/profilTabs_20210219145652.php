    ...
    <div class="col-12">
      <ul class="nav nav-tabs navbar-fixed-top" id="myTab" role="tablist">
        ...
        if(isset($_GET['id_user'])){?>
          ...
          <li class="nav-item" role="presentation">
            <a class="nav-link" id="message-tab" data-toggle="tab" href="#message" role="tab" aria-controls="messagetab" aria-selected="false">Messagerie</a>
          </li>
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="message" role="tabpanel" aria-labelledby="message-tab"><?php include('views/profil/messages.php')?></div>
