...
{ 
    ...
    public function userLogin(string $email, string $password) :array
    {
        $sql = "SELECT * FROM user 
                WHERE email = :email 
                AND 
                password = :password AND deleted = 0";
    ...
    public function getAllFromUserDesactivatedByEmail(string $email)
    {
        $sql = "SELECT * FROM user 
    ...
    public function getAccountDesactivated(string $email, string $password) :array
    {
        $sql = "SELECT * FROM user 
                WHERE email = :email 
                AND 
                password = :password AND deleted = 1";
    ...
    public function activateAccount(int $id_user){
        $sql = "UPDATE user SET deleted = 0 WHERE ID = :id_user";
        $query = $this->connect()->prepare($sql);
        $query->execute([
              "id_user" => $id_user
        ]);
