...
class TweetsRepository extends Db {
  ...
  {
    $sql = "SELECT retweet.ID_tweet as IDTweet, tweet.text as textTweet, tweet.ID_user as UserIDTweet, user.pseudo as pseudo, tweet.date, as dateTweet, aime.ID_user as isLiked from tweet 
