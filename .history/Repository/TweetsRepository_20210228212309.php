...
class TweetsRepository extends Db {
  ...
  {
    $sql = "SELECT tweet.ID as IDTweet, tweet.text as textTweet, tweet.ID_user as UserIDTweet, user.pseudo as pseudo, tweet.date as dateTweet, IF(aime.ID_user IS NULL, 0, 1) as isLiked, COUNT(tweet.id_tweet) as test FROM tweet 
