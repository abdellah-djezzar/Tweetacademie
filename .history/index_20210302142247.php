...
session_start();
  ...
  exit;
} elseif(!empty($_GET['action']) && ($_GET['action']) == "showMessage"){
  require('Controllers/ShowMessageController.php');
  exit;
}
...
} elseif($_GET['action'] == "homeMessage"){
  require('Controllers/homeMessageController.php');
} elseif($_GET['action'] == 'sendMessage') {
  require('Controllers/messageController.php');
} elseif($_GET['action'] == 'tag'){
  require('Controllers/TagController.php');
} elseif($_GET['action'] == 'ListHashTag'){
  require('Controllers/ListHashTagController.php');
} elseif($_GET['action'] == 'activateAccount'){
  require('Controllers/activateAccountController.php');
}
