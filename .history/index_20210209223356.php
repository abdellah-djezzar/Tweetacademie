<?php 
// ici c'est la page index. C'est là ou l'utilisateur arrive. selon les lien qu'il va cliquer on va le renvoyer vers telle ou telle vues. regardez bien à quoi ressemblent les url pour comprendre d'ou vient le "action". 
