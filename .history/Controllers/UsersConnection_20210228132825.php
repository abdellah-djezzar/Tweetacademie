...
if (isset($_SESSION['id']))
{
    ...
    if (isset($_POST["register"])){
        ...
        if(
            ...
            !empty($_POST["username"]) && preg_match("/[a-zA-Z]*/", $_POST["username"]) && ($checkUsername == TRUE) &&
            !empty($_POST["pseudo"]) && preg_match("/[a-zA-Z]*/", $_POST["pseudo"]) && ($checkPseudo !== FALSE) &&
            !empty($_POST["dob"]) && 
            !empty($_POST["email"]) && filter_var($_POST["email"], FILTER_VALIDATE_EMAIL) && ($checkPseudo !== FALSE) &&
